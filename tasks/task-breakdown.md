...
- Implementation status: focused API added for health, validation, conversion, ingest, list, read, and export. Invalid ingests are stored as rejected records for audit.
